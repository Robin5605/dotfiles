...
_G.packer_plugins = {
  ...
  ["nord.nvim"] = {
    loaded = true,
    path = "/home/robin/.local/share/nvim/site/pack/packer/start/nord.nvim",
  ...
  ["nvim-ts-autotag"] = {
    loaded = true,
    path = "/home/robin/.local/share/nvim/site/pack/packer/start/nvim-ts-autotag",
  ...
  ["presence.nvim"] = {
    loaded = true,
    path = "/home/robin/.local/share/nvim/site/pack/packer/start/presence.nvim",
